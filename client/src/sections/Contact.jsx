...
const contactInfo = [
  {
    ...
    href: "mailto:shivam10yadav05@gmail.com",
  },
  {
    icon: Phone,
    label: "Phone",
    value: "+91 9992669056",
    href: "tel:+91 9992669056",
  },
  {
    icon: MapPin,
    label: "Location",
    value: "Karnal Haryana, India",
    href: "#",
  },
];
    ...
    <section id="contact" className="py-16 sm:py-24 lg:py-32 relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 sm:px-6 relative z-10">
        ...
        <div className="grid lg:grid-cols-2 gap-6 sm:gap-8 lg:gap-12 max-w-5xl mx-auto">
          {/* Form */}
          <div className="glass p-6 sm:p-8 rounded-2xl sm:rounded-3xl border border-primary/30 animate-fade-in animation-delay-300">
            <form className="space-y-5 sm:space-y-6" onSubmit={handleSubmit}>
              <div>
                ...
                <input
                  ...
                  className="w-full px-4 py-2.5 sm:py-3 text-sm sm:text-base bg-surface rounded-xl border border-border focus:border-primary focus:ring-1 focus:ring-primary outline-none transition-all"
                />
              </div>
              ...
              <div>
                ...
                <textarea
                  ...
                  className="w-full px-4 py-2.5 sm:py-3 text-sm sm:text-base bg-surface rounded-xl border border-border focus:border-primary focus:ring-1 focus:ring-primary outline-none transition-all resize-none"
                />
              </div>
          ...
          <div className="space-y-5 sm:space-y-6 animate-fade-in animation-delay-400">
            ...
            {/* Availability Card */}
            <div className="glass rounded-2xl sm:rounded-3xl p-6 sm:p-8 border border-primary/30">
